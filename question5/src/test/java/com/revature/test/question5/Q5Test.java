...
import com.revature.question5.Q5Mapper;
import com.revature.question5.Q5Reducer;
...
public class Q5Test {
	...
	public void testMapper() {
		...
		mapDriver.withOutput(new Text("Czech Republic"), new Text("1%%1"));
	...
	public void testReducer() {
		...
		value1.add(new Text("1%%1"));
		value1.add(new Text("1%%1"));
		value1.add(new Text("2%%15000"));
		
		reduceDriver.withInput(new Text("Czech Republic"), value1);
		
		reduceDriver.withOutput(new Text("Czech Republic"), new Text("10\t15000.0"));
	...
	public void testMapReduce() {
		...
		mrDriver.addOutput(new Text("Czech Republic"), new Text("1\t0.0"));
